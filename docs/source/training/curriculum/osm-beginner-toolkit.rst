...
When organizing an OpenStreetMap workshop, numerous factors must be considered, including the length of time you have to train, available resources, number of trainee and their technical skills.  This toolkit will help trainers prepare trainings for different types of participants, but it will primarily focus on educating those with little or no experience with GPS, map making, and computers.
...
Schedule
^^^^^^^^
Below is *outline* of schedule for 5 days workshop that has been tested in several groups in different workshop in Indonesia. You may change some of them that might be more useful, applicable, and meet your needs depend on some factors must be considered as we have discussed before.
