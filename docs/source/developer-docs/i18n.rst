...
* Transifex account on www.transifex.org
* sudo pip install transifex-client
* go to /tmp and write tx init to create your .transifexrc file
* go back to inasafe-doc
...
and then wait quite a long time until the creation is finished.
...
timlinux@waterfall:~/dev/cpp/QGIS-Documentation$ msgfmt -c i18n/en/LC_MESSAGES/docs/user_manual/introduction/qgis_gui.po
